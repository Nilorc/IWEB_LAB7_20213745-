        ...
        <div class="container">
            ...
            <table class="table table-striped mt-3">
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-success" href="<%=request.getContextPath()%>/JobServlet?action=edit&id=<%= job.getJobId() %>">Editar</a>
                        <a onclick="return confirm('¿Está seguro de borrar?')" class="btn btn-danger" href="<%=request.getContextPath()%>/JobServlet?action=del&id=<%= job.getJobId() %>">Borrar</a>
                    </td>
                </tr>
                <% } %>
            </table>
